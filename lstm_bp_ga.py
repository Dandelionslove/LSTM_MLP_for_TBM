...
from lstm_bp_nn import LSTM_BP_Sequential_NN
import numpy as np
...
class Genetic(object):
    def __init__(self):
        ...
        self.nb_layers = [i for i in range(3, 10)]
        self.nb_nodes = [8, 16, 32, 48, 64, 72, 96]
    ...
    def create_population(self, strength):
        ...
        for _ in range(strength):
            ...
            parameters['hidden_layer_num'] = layer_num
            parameters['hidden_layer_dims'] = list()
            # 构建多个不同的模型
            for _ in range(layer_num):
                parameters['hidden_layer_dims'].append(np.random.choice(self.nb_nodes))
            ...
            for gene in self.param_choices:
                ...
                if np.random.random() < pc:
                    ...
                    if cross_gene == 'hidden_layer_num' or cross_gene == 'hidden_layer_dims':
                        ...
                        child['hidden_layer_num'] = p_sub['hidden_layer_num']
    ...
    def mutate(self, nn_parameters):
        ...
        if param_to_be_mutated == 'units':
        ...
        elif param_to_be_mutated == 'hidden_layer_num':
            ...
            elif new_layer_num > nn_parameters['hidden_layer_num']:
                for _ in range(new_layer_num - nn_parameters['hidden_layer_num']):
                    nn_parameters['hidden_layer_dims'].append(np.random.choice(self.nb_nodes))
    ...
    def evaluate_fitness(self, nn_parameters):
        ...
        #     return None
        nn = LSTM_BP_Sequential_NN(nn_parameters)
